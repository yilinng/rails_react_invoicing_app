    ...
    return (
        ...
        <div className="row">
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="form-group">
                <button style={{backgroundColor: "#5ca904", color: "white", fontWeight: "bolder"}} className="btn createOne">Create Invoice</button>
                { loading && <span>{ loading }</span> }
                {error && <span className="createError">{ error }</span>}
                </div>
                </div>
            </form>
            </div>
